...
public class CDItemProjectileModel extends EntityModel<CDItemProjectileEntity> {
    ...
    @Override
    public void setupAnim(CDItemProjectileEntity entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
