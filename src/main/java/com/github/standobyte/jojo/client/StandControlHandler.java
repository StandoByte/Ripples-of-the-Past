...
public class StandControlHandler {
    private static StandControlHandler instance = null;
    ...
    private StandControlHandler(Minecraft mc) {
        this.mc = mc;
    ...
    public static void init(Minecraft mc) {
        if (instance == null) {
            instance = new StandControlHandler(mc);
            MinecraftForge.EVENT_BUS.register(instance);
        }
    }

    public static StandControlHandler getInstance() {
        return instance;
    }
    ...
    public void renderStandGui(RenderGameOverlayEvent.Pre event) {
        ...
        if (!mc.options.hideGui) {
            ...
            case TEXT:
                ...
                if (damageFactor < 1) {
                    mc.gui.drawString(matrixStack, mc.font, I18n.get("overlay.stand_strength", String.format("%.2f%%", damageFactor * 100F)), 3, 114, 0XFF4040);
                }
                break;
            default:
                break;
