...
public class ModifiedRenderTypeBuffers extends IRenderTypeBuffer.Impl {
    ...
    public static IRenderTypeBuffer.Impl create(BufferBuilder builder, IRenderTypeBuffer.Impl originalBuffers, UnaryOperator<RenderType> remapFunction) {
        ...
        return new ModifiedRenderTypeBuffers(builder, fixedBuffersRemapped, renderTypesRemapped, remapFunction);
    }

    protected ModifiedRenderTypeBuffers(BufferBuilder builder, 
