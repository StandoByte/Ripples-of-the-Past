...
public class KosmXLightFlashDecoyHandler extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {
	private static final float SPEED = 1.0F;

    public KosmXLightFlashDecoyHandler(ResourceLocation id) {
        super(id);
    }
    ...
    private static final ResourceLocation ANIM = new ResourceLocation(JojoMod.MOD_ID, "light_flash_decoy");
    @Override
