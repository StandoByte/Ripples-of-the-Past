...
public class MRFireballModel extends EntityModel<MRFireballEntity> {
    ...
    public MRFireballModel() {
        ...
        emerald.texOffs(0, 19).addBox(-1.5F, -1.0F, -4.5F, 3.0F, 2.0F, 9.0F, 0.0F, false);
    }

    @Override
    public void setupAnim(MRFireballEntity entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
