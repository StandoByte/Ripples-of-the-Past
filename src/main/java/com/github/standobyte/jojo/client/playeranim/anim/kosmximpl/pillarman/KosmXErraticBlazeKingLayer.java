...
public class KosmXErraticBlazeKingLayer extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {

    public KosmXErraticBlazeKingLayer(ResourceLocation id) {
        super(id);
    }
