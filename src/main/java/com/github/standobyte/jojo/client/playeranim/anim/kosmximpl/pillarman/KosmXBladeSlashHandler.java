...
public class KosmXBladeSlashHandler extends AnimLayerHandler<ModifierLayer<IAnimation>> implements BasicToggleAnim {
    private static final float SPEED = 1.5F;

    public KosmXBladeSlashHandler(ResourceLocation id) {
        super(id);
    }
    ...
    private static final ResourceLocation ANIM = new ResourceLocation(JojoMod.MOD_ID, "blade_slash");
    @Override
